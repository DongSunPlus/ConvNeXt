...
###
 ...
 # @LastEditTime: 2022-08-25 15:41:01
...
train() {
    ...
    nums_node=${#array[@]}
    python -m torch.distributed.launch --nproc_per_node=$nums_node --master_port 9905 main.py \
    --model convnext_tiny \
    --finetune /home/dong.sun/ConvNeXt/weights/convnext_tiny_22k_224.pth\
    --model_prefix /home/dong.sun/ConvNeXt/weights/convnext_tiny_22k_224.pth\
    --drop_path 0.1 \
    --batch_size 10 \
    --input_size 224 \
    ...
    --model_ema true \
    --model_ema_eval true \
    --data_path /home/dong.sun/data/iqa_datav2/train \
    --eval_data_path /home/dong.sun/data/iqa_datav2/val \
    --output_dir /home/dong.sun/workspace/ConvNeXt/exp/$exp_id/model \
    --log_dir /home/dong.sun/workspace/ConvNeXt/exp/$exp_id/log
}
